...
const SERVICES = [
  { icon: "Layers", title: "Беседки и террасы", desc: "Безрамное остекление открытых зон отдыха. Создаём уютное пространство, защищённое от ветра и осадков круглый год.", price: "от 4 500 ₽/м²" },
